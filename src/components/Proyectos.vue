  ...
  },
{
  ...
  },
  {
    ...
    links: [
      {
        text: "GitHub",
        href: "https://github.com/JoseMartinez98/Introduction-to-pentesting---machine-1",
        type: "github",
      },
    ],
  },
  {
    title: "Pentesting & pivoting machine 2",
    image: import.meta.env.BASE_URL + "image/pivoting.jpg",
    tags: ["metasploit", "nmap", "hydra"],
    links: [
      {
        text: "GitHub",
        href: "https://github.com/JoseMartinez98/Introduction-to-pentesting-pivoting---machine-2",
        type: "github",
      },
    ],
  },
...
.project-card {
  ...
  box-shadow:
    ...
    0 0 0 1px rgba(255, 255, 255, 0.1); /* Sombra elegante */
  transition:
    transform 0.3s ease,
...
.project-card:hover {
  ...
  box-shadow:
    0 15px 35px rgba(157, 157, 157, 0.8),
